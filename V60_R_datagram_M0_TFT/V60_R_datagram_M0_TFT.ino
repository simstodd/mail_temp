// V60_R_datagram_M0_TFT.ino sample code with my changes rf95_reliable_datagram_server.pde
...
// It is designed to work with v60 32u4 rf95_reliable_datagram_client
...
//https://learn.adafruit.com/adafruit-feather-m0-radio-with-lora-radio-module?view=all
//battery managament
//working with v60 client, need to add back in tft drawing from data
/*
...
delay(500);
Serial.println("V60_R_datagram_M0_TFT V57 M0 zero server 0x2 test with TFT");
...
//  Serial.println(testFastLines(ILI9341_CYAN, ILI9341_PINK));
 ...
 tft.fillScreen(ILI9341_BLACK);
  ...
  tft.print("M0/TFT/LoRA receiver test# v60 ");
  delay(4000);
  tft.fillScreen(ILI9341_BLACK);
  tft.print("M0/TFT/LoRA receiver test# v60 ");
...
uint8_t data[] = "Hello litle 32u4 from v60 M0 server with TFT";

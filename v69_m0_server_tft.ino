...
//  Serial.println(testFastLines(ILI9341_CYAN, ILI9341_PINK));
 ...
 tft.fillScreen(ILI9341_BLACK);
  ...
  tft.print("M0/TFT/LoRA receiver test# v64 ");
  delay(4000);
  tft.fillScreen(ILI9341_BLACK);
  tft.setCursor(50,50);
  tft.print("M0/TFT/LoRA receiver test# v69 ");
...
uint8_t data[] = "Hello litle 32u4 from v63 M0 server (0x2) with TFT";

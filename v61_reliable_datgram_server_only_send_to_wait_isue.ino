// V61 sample code with my changes rf95_reliable_datagram_server.pde
// issue with sendtowaitfailed and no packet counter
...
delay(500);
Serial.println("V56 M0 zero server 0x2 test with TFT");
...
//  Serial.println(testFastLines(ILI9341_CYAN, ILI9341_PINK));
 ...
 tft.fillScreen(ILI9341_BLACK);
  ...
  tft.print("M0/TFT/LoRA receiver test# v55 ");
  delay(4000);
  tft.fillScreen(ILI9341_BLACK);
  tft.print("M0/TFT/LoRA receiver test# v55 ");
...
uint8_t data[] = "Hello litle 32u4 from v56 M0 server with TFT";

// v64_32u4_R_Datagram_Client_with_BME280
...
//remove//
  ...
  Serial.println("BME280 and Feather Addressed RFM95 TX - Client 32u4 Test v64! sleep till for 8s loops or interrupt");
...
uint8_t data[] = "Hello from 32u4 peripheral V64";
...
void transmitStatus()//test function
{
  ...
  //get BME data
     ...
     */ 
     ...
     // printValues();
    Serial.print("T: ");
    Serial.print(databufT);
    Serial.print(" P: ");
    Serial.print(databufP);
    Serial.print(" H: ");
    Serial.print(databufH);
    Serial.print(" %");
        Serial.print(databufHH);
    Serial.println(" %");
  // Send a message to manager_server
  
  
  char radiopacket[40] = "Hello World v64: #         ";
  
  //increment packet counter
  //packetnum++;
  Serial.print("Sending packet #"); 
  Serial.print(packetnum);Serial.print("......\""); 
  sprintf(radiopacket,"Status: A:%d T:%s H:%s P:%s #\"", aLert, databufT, databufHH, databufP);
  itoa(packetnum++, radiopacket+39, 10); //itoa(packetnum++, radiopacket+29, 10);

// V69_R_datagram_M0_TFT.ino sample code with my changes rf95_reliable_datagram_server.pde
...
delay(500);
Serial.println("V69_R_datagram_M0_TFT");
...
Serial.println("Radio test done, setup done");

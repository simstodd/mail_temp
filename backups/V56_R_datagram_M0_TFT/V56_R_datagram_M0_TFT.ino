// V56_R_datagram_M0_TFT.ino sample code with my changes rf95_reliable_datagram_server.pde
...
delay(500);
Serial.println("V56_R_datagram_M0_TFT V56 M0 zero server 0x2 test with TFT");
...
//  Serial.println(testFastLines(ILI9341_CYAN, ILI9341_PINK));
 ...
 tft.fillScreen(ILI9341_BLACK);
  ...
  tft.print("M0/TFT/LoRA receiver test# v56 ");
  delay(4000);
  tft.fillScreen(ILI9341_BLACK);
  tft.print("M0/TFT/LoRA receiver test# v56 ");

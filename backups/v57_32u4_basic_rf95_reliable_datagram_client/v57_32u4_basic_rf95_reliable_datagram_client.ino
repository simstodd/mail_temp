// v57_32u4_R_Datagram_Client_with_BME280
// rf95_reliable_datagram_client.pde
//adding sleep till interrupt and timer checking, need to add packet counter and sensor status
//this is working , need to try older one to doublecheck what went wrong
...
//remove//
  ...
  Serial.println("BME280 and Feather Addressed RFM95 TX - Client 32u4 Test v57! sleep till for 8s loops or interrupt");
...
uint8_t data[] = "Hello from 32u4 peripheral V57";
...
void loop()
{
 ...
 //send a message if its time
  ...
  Serial.println("Sending to V57_R_datagram_M0_TFT");
  transmitStatus();  //actually send a message 

//http://wiki.aprbrother.com/wiki/ESP_Soil_Moisture_Sensor#Description
//https://github.com/AprilBrother/esp-soil-moisture-sensor
//http://wiki.aprbrother.com/wiki/ESPea
//temp sensor AP2112k datasheet: https://cdn-shop.adafruit.com/product-files/2471/AP2112.pdf
// or better http://www.qsl.net/v/ve2cuz//garden/
...
String API_KEY ="M2ZMUM8WVWUM7MTL";
const char* MY_SSID = "Office"; 
const char* MY_PWD = "QAZch1p!1";
...
//You can calculate the relative humidity with these values.
  ...
  perCtmp = map(tmp,400,860,0,100); //uses map funtion https://www.arduino.cc/reference/en/language/functions/math/map/
  return perCtmp;
  //return tmp;
}
...
//
  ...
  Serial.println("Requesting Todd...");

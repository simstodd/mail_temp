...
//remove//
  ...
  Serial.println("BME280, 32u4 Feather RFM95 TX - Client Test v51! sleep loop/interrupt");
    
    delay(1500); //let sensor boot
    
    Serial.println(F("BME280 test v51"));
...
delay(500);
   ...
   Serial.println(databufP);    
     ...
     // Serial.println(databufH);
      //HumidValC[7] = databufH[7];
     // Serial.print("The HumidValC is: ");
    //Serial.println(HumidValC);
    //memcpy( databufH, HumidValC, 5*sizeof(int) );
      //  Serial.print("The HumdValC is: ");
   // Serial.println(HumidValC);
   
     
     // Serial.println(databufT);
    ...
    //Serial.println(databufH);
    itoa(packetnum++, radiopacket+31, 10); //itoa(packetnum++, radiopacket+29, 10);

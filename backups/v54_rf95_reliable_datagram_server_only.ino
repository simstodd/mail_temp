// V54 sample code with my changes rf95_reliable_datagram_server.pde
...
//m0 test because there were intermittent connection issiues and reply failures.. 
...
//  digitalWrite(4, HIGH);
  ...
  if (!manager.init())
    Serial.println("RF95 Server init failed");
...
Serial.println("V54 M0 zero server 0x2 test");

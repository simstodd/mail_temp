...
#define DEST_ADDRESS   2 //server M0 - not this board
#define MY_ADDRESS     1  //client - sensor - this one 32u4
...
void setup()
{
   delay(15000); //needed to avoid no serial issue on boot to reload program
   Serial.begin(9600);
...
//remove//
  ...
  Serial.println("BME280 and Feather Addressed RFM95 TX - Client 32u4 Test v58! sleep till for 8s loops or interrupt");

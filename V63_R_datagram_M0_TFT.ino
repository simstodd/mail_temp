...
// It is designed to work with v63 32u4 rf95_reliable_datagram_client
//https://learn.adafruit.com/adafruit-feather-m0-radio-with-lora-radio-module?view=all
//http://www.airspayce.com/mikem/arduino/RadioHead/classRHReliableDatagram.html
...
//https://learn.adafruit.com/adafruit-feather-m0-radio-with-lora-radio-module?view=all
//battery managament
//working with v63 32u4 client, workign on tft drawing now 
...
delay(500);
Serial.println("V63_R_datagram_M0_TFT");
...
//  Serial.println(testFastLines(ILI9341_CYAN, ILI9341_PINK));
 ...
 tft.fillScreen(ILI9341_BLACK);
  ...
  tft.print("M0/TFT/LoRA receiver test# v63 ");
  delay(4000);
  tft.fillScreen(ILI9341_BLACK);
  tft.setCursor(50,50);
  tft.print("M0/TFT/LoRA receiver test# v63 ");

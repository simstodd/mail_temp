// v63_32u4_R_Datagram_Client_with_BME280
...
//remove//
  ...
  Serial.println("BME280 and Feather Addressed RFM95 TX - Client 32u4 Test v63! sleep till for 8s loops or interrupt");
...
void transmitStatus()//test function
{
  ...
  char radiopacket[40] = "Hello World v63: #         ";
